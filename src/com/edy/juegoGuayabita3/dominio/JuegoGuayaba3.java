...
public class JuegoGuayaba3 {
    ...
    public JuegoGuayaba3(double apuestaInicial) {
    ...
    public void iniciarJuego(Player3 jugador1, Player3 jugador2){
    ...
    public boolean validarApostar(Player3 jugador, double cantidadApostada){
