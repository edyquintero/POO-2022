...
public class AppClinica {
    public static void main(String[] args) {
        ...
        edy.agregar(edy.revisarPaciente("alex", 20, true));
        edy.agregar(edy.revisarPaciente("camilo", 20, true));
        edy.agregar(edy.revisarPaciente("Andrea", 29, true));
        edy.agregar(edy.revisarPaciente("andres", 59, true));
